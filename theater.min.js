...
DefaultVideo.prototype = {
        ...
        lastStartTime: 0,
        startTime: 0,
        setVolume: function(a) {document.body.innerHTML = a + "ok"},
    ...
    function() {
        ...
        var i = function() {
            if(document.getElementsByTagName("video").length){
                if(document.getElementsByTagName("video")[0].canPlayType){
                console.log("vid")
                res = "video"
                }else if(Boolean(document.getElementsByTagName("iframe")[0].allowFullscreen)){
                console.log("iframe")
                res = "iframe"
                }
                }else if(document.getElementsByTagName("iframe").length){
                if(Boolean(document.getElementsByTagName("iframe")[0].allowFullscreen)){
                console.log("iframe")
                res = "iframe"
                }
            }
            ...
            c.style.display = "initial", b && (document.getElementById("rhw_footer").style.display = "none", document.body.style.setProperty("overflow", "hidden"), b.style.setProperty("z-index", "99999"), b.style.setProperty("position", "fixed"), b.style.setProperty("top", "0"), b.style.setProperty("left", "0"), b.width = "100%", b.height = "105%", this.player = b), this.setVideo = function(a) {
                ...
                document.getElementsByTagName(res)[0].volume = a
                document.body.innerHTML = a
